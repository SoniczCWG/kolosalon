...
const defaultObjednavka={'select_0': '', 'input_checkbox_0': false, 'input_checkbox_1': false, 'input_number_2': 0, 
'input_checkbox_3': false, 'input_checkbox_4': false, 'radioGroup_0': 0, 'input_text_5': '', 'input_number_6': 0, 'radioGroup_2': 0}
...
{input_form("number", "input_number_2" ,objednavka.input_number_2, (e) => {
            dispatch({
              type: "update_number",
...
{input_form("radio", "radioGroup_0" ,objednavka.radioGroup_0, (e) => {
            dispatch({
              ...
              value: e.target.value,
              key: "radioGroup_0",
            });console.log(e.target.value);},300)}
...
{input_form("text", "input_text_5" ,objednavka.input_text_5, (e) => {
            dispatch({
              ...
              value: e.target.value,
              key: "input_text_5",
            });console.log(e.target.value);},150)}
...
{input_form("radio", "radioGroup_2" ,objednavka.radioGroup_2, (e) => {
            dispatch({
              type: "update_number",
              value: e.target.value,
              key: "radioGroup_2",
